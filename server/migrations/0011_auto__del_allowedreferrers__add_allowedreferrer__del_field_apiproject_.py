...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AllowedReferrer'
        db.create_table(u'server_allowedreferrer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('APIProject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.APIProject'])),
            ('url', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'server', ['AllowedReferrer'])

        # Deleting field 'APIProject.description'
        db.delete_column(u'server_apiproject', 'description')

        # Deleting field 'APIProject.how_long'
        db.delete_column(u'server_apiproject', 'how_long')

        # Adding field 'APIProject.original_request'
        db.add_column(u'server_apiproject', 'original_request',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['server.APIProjectRequest']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AllowedReferrer'
        db.delete_table(u'server_allowedreferrer')


        # User chose to not deal with backwards NULL issues for 'APIProject.description'
        raise RuntimeError("Cannot reverse this migration. 'APIProject.description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'APIProject.description'
        db.add_column(u'server_apiproject', 'description',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'APIProject.how_long'
        raise RuntimeError("Cannot reverse this migration. 'APIProject.how_long' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'APIProject.how_long'
        db.add_column(u'server_apiproject', 'how_long',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

        # Deleting field 'APIProject.original_request'
        db.delete_column(u'server_apiproject', 'original_request_id')
