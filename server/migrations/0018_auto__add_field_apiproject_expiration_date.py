...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APIProject.expiration_date'
        db.add_column(u'server_apiproject', 'expiration_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APIProject.expiration_date'
        db.delete_column(u'server_apiproject', 'expiration_date')
