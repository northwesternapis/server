...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'server_coursecomponent', 'meeting_days', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.meeting_days'
        db.alter_column(u'server_course', 'meeting_days', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
