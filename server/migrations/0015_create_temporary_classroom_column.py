...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename the current room field on the Course model
        db.rename_column(u'server_course', 'room', 'room_temp')

        # Add a new one for the new room ForeignKey
        db.add_column(u'server_course', 'room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Room'], null=True))


    def backwards(self, orm):
        db.delete_column(u'server_course', 'room')
        db.rename_column(u'server_course', 'room_temp', 'room')
