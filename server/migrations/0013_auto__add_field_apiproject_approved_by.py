...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APIProject.approved_by'
        db.add_column(u'server_apiproject', 'approved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='projects_approved', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APIProject.approved_by'
        db.delete_column(u'server_apiproject', 'approved_by_id')
