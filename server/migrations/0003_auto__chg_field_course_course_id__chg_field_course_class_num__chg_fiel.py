...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.course_id'
        db.alter_column(u'server_course', 'course_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Course.class_num'
        db.alter_column(u'server_course', 'class_num', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Term.term_id'
        db.alter_column(u'server_term', 'term_id', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Course.course_id'
        db.alter_column(u'server_course', 'course_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Course.class_num'
        db.alter_column(u'server_course', 'class_num', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Term.term_id'
        db.alter_column(u'server_term', 'term_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
