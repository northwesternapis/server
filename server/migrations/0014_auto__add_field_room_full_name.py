...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Room.full_name'
        db.add_column(u'server_room', 'full_name',
                      self.gf('django.db.models.fields.TextField')(default='bob'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Room.full_name'
        db.delete_column(u'server_room', 'full_name')
