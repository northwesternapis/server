...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AllowedReferrer.APIProject'
        db.delete_column(u'server_allowedreferrer', 'APIProject_id')

        # Adding field 'AllowedReferrer.project'
        db.add_column(u'server_allowedreferrer', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['server.APIProject']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AllowedReferrer.APIProject'
        raise RuntimeError("Cannot reverse this migration. 'AllowedReferrer.APIProject' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'AllowedReferrer.APIProject'
        db.add_column(u'server_allowedreferrer', 'APIProject',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.APIProject']),
                      keep_default=False)

        # Deleting field 'AllowedReferrer.project'
        db.delete_column(u'server_allowedreferrer', 'project_id')
