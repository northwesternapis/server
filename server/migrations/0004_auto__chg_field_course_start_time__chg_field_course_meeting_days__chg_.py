...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'server_course', 'start_time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Course.meeting_days'
        db.alter_column(u'server_course', 'meeting_days', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))

        # Changing field 'Course.end_time'
        db.alter_column(u'server_course', 'end_time', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Course.start_time'
        db.alter_column(u'server_course', 'start_time', self.gf('django.db.models.fields.TimeField')(default=None))

        # Changing field 'Course.meeting_days'
        db.alter_column(u'server_course', 'meeting_days', self.gf('django.db.models.fields.CharField')(default=None, max_length=11))

        # Changing field 'Course.end_time'
        db.alter_column(u'server_course', 'end_time', self.gf('django.db.models.fields.TimeField')(default=None))
