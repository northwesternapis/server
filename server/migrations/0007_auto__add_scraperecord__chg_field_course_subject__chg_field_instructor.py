...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScrapeRecord'
        db.create_table(u'server_scraperecord', (
            ...
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Subject'])),
        ))
        db.send_create_signal(u'server', ['ScrapeRecord'])


        # Changing field 'Course.subject'
        db.alter_column(u'server_course', 'subject', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Instructor.phone'
        db.alter_column(u'server_instructor', 'phone', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Deleting model 'ScrapeRecord'
        db.delete_table(u'server_scraperecord')


        # Changing field 'Course.subject'
        db.alter_column(u'server_course', 'subject', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Instructor.phone'
        db.alter_column(u'server_instructor', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
