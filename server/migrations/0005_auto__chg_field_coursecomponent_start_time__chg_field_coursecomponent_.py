...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseComponent.start_time'
        db.alter_column(u'server_coursecomponent', 'start_time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'CourseComponent.end_time'
        db.alter_column(u'server_coursecomponent', 'end_time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'CourseComponent.meeting_days'
        db.alter_column(u'server_coursecomponent', 'meeting_days', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))

    def backwards(self, orm):

        # Changing field 'CourseComponent.start_time'
        db.alter_column(u'server_coursecomponent', 'start_time', self.gf('django.db.models.fields.TimeField')(default=None))

        # Changing field 'CourseComponent.end_time'
        db.alter_column(u'server_coursecomponent', 'end_time', self.gf('django.db.models.fields.TimeField')(default=None))

        # Changing field 'CourseComponent.meeting_days'
        db.alter_column(u'server_coursecomponent', 'meeting_days', self.gf('django.db.models.fields.CharField')(default=None, max_length=11))
