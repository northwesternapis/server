...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseComponent.room'
        db.alter_column(u'server_coursecomponent', 'room', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'CourseComponent.room'
        db.alter_column(u'server_coursecomponent', 'room', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
